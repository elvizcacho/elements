...
exports[`Test the editable text component should be using a custom decoration color 1`] = `
Snapshot Diff:
- First value
+ Second value
...
exports[`Test the editable text component should be using a custom icon color 1`] = `
.css-0,
[data-css-0] {
  margin-left: 4px;
}
